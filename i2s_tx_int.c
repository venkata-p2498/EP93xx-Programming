...
#define i2sclockdiv((volatile unsigned*)(0x8093008c))
#define i2dev_cong((volatile unsigned*)(0x80930080))
int data[40] = {0x20,0x28,0x30,0x37,0x3c,0x3f,0x40,0x3f,0x3c,0x37,0x30,0x28,0x20,0x18,0x10,0x09,0x04,0x01,0x00,0x01,0x04,0x09,0x10,0x18,0x20};
int i,j=0;
